            ...
            <>
                ...
                <li><Link to="/" onClick={logoutUser}>
                        <svg className="nav__logoutIcon" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14.495 3.625H3.625V25.375H14.5" stroke="white" stroke-width="2.41667" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M19.9375 19.9375L25.375 14.5L19.9375 9.0625" stroke="white" stroke-width="2.41667" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M9.66669 14.495H25.375" stroke="#FFFDFD" stroke-width="2.41667" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
